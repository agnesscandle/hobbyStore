...
<div class="divReserve">
    <div class="ul">
       <ul class="gnb">
          ...
          <li class="step step-5"><span>결제 방식 선택 및 약관 동의</span></li>
       </ul>
    </div>
 
 	<form id="reserveForm" action="${path}/hobby/reserve" method="POST">
       ...
       <div class="reserve reserve-5">
          <section>
             <div class="title">
                ...
                <span>결제 방식 선택</span> 
                    <input type="radio" class="req" id="kakaoPay" name="check1" value="kakaoPay"/> 카카오 페이
                    <input type="radio" class="req" id="accountPay" name="check1" value="accountPay"/> 무통장 입금

                <span>약관 동의</span> 
                    우측 화면에 보이는 약관을 읽어보신 후, 아래 체크 박스를 선택해 주세요. <br>
                    <input type="checkbox" id="term" name="check2" value="clause" required/> 
                    개인정보 제 3자 제공 동의, 결제 대행 서비스 이용 약관 등 모든 약관에 동의합니다. (필수) 
             ...
             <div class="warn">
                <p>
                    ...
                    '취미상점'은 사용자들의 개인정보를 개인정보 취급방침의 '제 2조 수집하는 개인정보의 항목, 수집방법 및 이용목적'에서 고지한 범위 내에서 사용하며, <br>
                    ...
                    사용자가 이용함에 있어 회사와 사용자 사이의 전자금융거래에 관한 기본적인 사항을 정함을 목적으로 함을 약속합니다.<br><br>
                    - 회사는 전자금융거래 서비스를 제공함에 있어서 취득한 이용자의 인적사항, 이용자의 계좌, 접근매체 및 전자금융거래의 내용과 실적에 관한 정보 또는 자료를 
                    이용자의 동의를 얻지 아니하고 제3자에게 제공,누설하거나 업무상 목적 외에 사용하지 아니합니다. <br>
